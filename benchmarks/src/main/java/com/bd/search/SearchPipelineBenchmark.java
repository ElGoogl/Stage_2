 ...
 * SCOPE: Complete search workflows with dynamic scaling (10x, 100x iterations)
...
public class SearchPipelineBenchmark {
    ...
    private int getBookCount() {
        try {
            String content = Files.readString(Paths.get("../indexing_service/data_repository/indexed_books.json")).trim();
    ...
    private void printConfiguration() {
        ...
        String message = bookCount >= 100 ? "All benchmarks (10x, 100x) will run" :
